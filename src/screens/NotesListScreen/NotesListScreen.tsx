...
export type NotesListScreenNavigationProp = NativeStackNavigationProp<RootStackParamList, 'NotesList'>;
export type NotesListScreenRouteProp = RouteProp<RootStackParamList, 'NotesList'>;
